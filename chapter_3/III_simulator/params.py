...
#%% HYPERPARAMETERS
N=23 # number of species. Has an important relation with the mutualRange and connectance (c) parameters
nloci=100 # number of loci
ps=(500,600) # phenotypic space. Has an important relation with the alpha parameter
ntimesteps = 120 # number of generations simulated
...
a=np.random.rand(nsimulations)*0.05#0. # assortative mating coefficients, real value (single value or array of N values)
d=np.linspace(-20,20,nsimulations) # frequency dependence coefficient
alpha= 0.01 #0.1 # strength of the trait matching mechanism. Positive real value. Lower values = greater promiscuity
...
D0=100
surround=100 #saturation of the interaction environment
